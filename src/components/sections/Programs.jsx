    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          <Reveal width="100%">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Inisiatif strategis Himapro untuk mendukung pendidikan, sosial,
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Reveal className="relative hover:z-10 transition-all">
            <div className="glass-card rounded-2xl p-8 flex flex-col group h-full">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed flex-grow">
                Sosialisasi pendidikan tinggi ke berbagai sekolah menengah di
                Probolinggo untuk memotivasi siswa melanjutkan studi.
              </p>
              <a
                className="inline-flex items-center text-primary font-bold group-hover:gap-2 transition-all"
                href="#"
              >
                Selengkapnya{" "}
          ...
          <Reveal>
            <div className="glass-card rounded-2xl p-8 flex flex-col group border-primary/40 h-full">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed flex-grow">
                Bentuk kepedulian nyata melalui aksi kemanusiaan, bakti sosial,
          ...
          <Reveal>
            <div className="glass-card rounded-2xl p-8 flex flex-col group h-full">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed flex-grow">
                Momen silaturahmi akbar bagi seluruh anggota Himapro untuk
                memperkuat solidaritas dan jejaring profesional.
              </p>
              <a
                className="inline-flex items-center text-primary font-bold group-hover:gap-2 transition-all"
                href="#"
